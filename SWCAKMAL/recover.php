...
<br /><br /><br /><br />
<p>Powered By Zul Azri Bin Jalalludin</p>
</form>';
}
}
if ($wapakpak == 0) {
	...
	<br>
	<p> if you think this is an error please Contact one of our Excoss or send an email to tazrai96@gmail.com</p>
	<br>
	Powered By Zul Azri Bin Jalalludin
	</div>';
